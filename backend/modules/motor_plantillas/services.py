...
def ensure_column(conn: sqlite3.Connection, table: str, column: str, definition: str) -> None:
    try:
        if database.is_sqlite or not database.database_url:
...
def init_schema(database_path: str) -> None:
    ...
    schema_sql = MOTOR_PLANTILLAS_SCHEMA_SQL
    # Sin DATABASE_URL, dbapi_compat usa el archivo SQLite recibido aunque el
    # motor central todavía no haya inicializado su dialecto.
    if database.is_sqlite or not database.database_url:
