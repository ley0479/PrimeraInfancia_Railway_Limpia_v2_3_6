...
def dashboard_base_maestra(database_path: str, ctx: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    cargas = repo.fetch_all("SELECT * FROM cargas_archivos WHERE fundacion_id = ? ORDER BY fecha_carga DESC, id DESC LIMIT 20", (fundacion_id,))
    ...
    return {'version_activa': version, 'resumen': resumen, 'cargas': cargas, 'borradores': borradores}
